...
test_description() {
  case "$1" in
    ...
    test-m9-linux-trace) echo "M9 #106 bounded Linux compatibility trace QEMU acceptance" ;;
    ...
    test-m9-linux-runtime) echo "M9 #103 Linux runtime/memory/time/poll syscalls" ;;
    ...
    test-m9-userspace) echo "M9 #107 BusyBox userspace convergence acceptance" ;;
...
test_aliases() {
  case "$1" in
    ...
    test-m9-linux-trace) echo "m9-linux-trace m9.106" ;;
    ...
    test-m9-linux-runtime) echo "m9-linux-runtime m9.103" ;;
    test-m9-rootfs) echo "m9-rootfs m9.104" ;;
    test-m9-linux-fs) echo "m9-linux-fs m9.101" ;;
    test-m9-userspace) echo "m9-userspace m9.107" ;;
